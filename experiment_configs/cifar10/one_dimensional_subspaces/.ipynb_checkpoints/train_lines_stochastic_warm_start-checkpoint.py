...
if __name__ == "__main__":
    ...
    for seed in range(2):
        ...
        args.trainer = "train_one_dim_subspaces_stochastic"
        args.warmup_length = 5
        args.data_seed = 0
        args.train_update_bn = True
        args.update_bn = True
        for epochs in [int(160 / 4), int(160 / 2)]:
            for optimizer in ['sgd']:
                for lr in [0.1]:
                    ...
                    args.name = (
                        f"id=lines_stochastic_warm+ln={args.label_noise}"
                    ...
                    args.duplicate_state_dict = True
                    args.resume = [
